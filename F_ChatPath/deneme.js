$(document).ready(() => {
    ...
    //     connection.invoke("GetNickName", nickName).catch(error => console.log(error, "btnGirisYapta problem var"));
    ...
    $("#btnGirisYap").click(() => {
        const nickName = $("#txtNickName").val();
        const sanitizedNickName = $("<div>").text(nickName).html(); // XSS önlemi
